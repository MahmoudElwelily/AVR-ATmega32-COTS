...
*/
#define  TMR_u8_TIMER0_PRESCALER    TMR_u8_NO_PRESCALER
...
/*Macros for the preload value for each timer (0,1,2)*/
#define  TMR_u8_TIMER0_PRELOAD    0
#define  TMR_u8_TIMER1_PRELOAD    0
#define  TMR_u8_TIMER2_PRELOAD    0

/*Macros for the number of required overflows according to the desired time for each timer (0,1,2)*/
#define  TMR_u32_TIMER0_REQ_OVF_CNT    15625
#define  TMR_u32_TIMER1_REQ_OVF_CNT    0
#define  TMR_u32_TIMER2_REQ_OVF_CNT    0
