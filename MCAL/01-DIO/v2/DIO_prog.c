...
#define DIO_u8_PIN31_INIT_VAL DIO_u8_INIT_LOW
	...
	/*
	 * Setting the value of pins of PORT(A-D) according to the initialized values assigned in the configuration file.
	 */
	DIO_PU_PORTA = CONC_8BITS (DIO_u8_PIN0_INIT_VAL,
			...
			DIO_u8_PIN7_INIT_VAL);

	DIO_PU_PORTB = CONC_8BITS (DIO_u8_PIN8_INIT_VAL,
			...
			DIO_u8_PIN15_INIT_VAL);

	DIO_PU_PORTC = CONC_8BITS (DIO_u8_PIN16_INIT_VAL,
			...
			DIO_u8_PIN23_INIT_VAL);

	DIO_PU_PORTD = CONC_8BITS (DIO_u8_PIN24_INIT_VAL,
